...
function resolvePersonaLocale(setting, hostLocale) {
...
function validateAgencySettings(value, locale = "zh") {
	if (value.personaLocale !== void 0 && !PERSONA_LOCALES.includes(value.personaLocale)) throw customError("invalid", locale);
...
function createExpertLibrary(base, store, divisions, locale) {
	...
	const library = {
		...
		getPersonaLocale() {
			...
			return {
				personaLocale: value !== void 0 && PERSONA_LOCALES.includes(value) ? value : "follow",
				revision: store.revision()
			};
		},
...
function apply(ctx, config) {
	...
	const personaLocale = () => resolvePersonaLocale(settingsSource().personaLocale, activeLocale());
...
//#endregion
export { readHostLocale as A, validateSummonSpecs as C, customExpertInputSchema as D, catalogSnapshotSchema as E, settingsNamespaceCompat as M, ZH_NAME as N, expertEditSchema as O, unquote as S, CUSTOM_EXPERT_SLUG as T, resolveExpert as _, SUMMON_EXPERTS_MAX as a, toSummonItemResult as b, createAgencyPersonaSource as c, mapPool as d, name as f, resolveCatalogRoot as g, readLocalizedExpertPrompt as h, SUMMON_EXPERTS_CONCURRENCY as i, resolvePersonaLocale as j, formatHost as k, inject as l, readExpertPrompt as m, Config as n, SUMMON_TASK_MAX_CHARS as o, parseFrontmatter as p, DEFAULT_DIVISIONS as r, apply as s, AGENCY_PERSONA_SERVICE as t, loadCatalog as u, sanitize as v, AGENCY_LIBRARY_SERVICE as w, truncate as x, stripBom as y };
