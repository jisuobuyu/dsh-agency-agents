import { A as readHostLocale, D as customExpertInputSchema, E as catalogSnapshotSchema, M as settingsNamespaceCompat, O as expertEditSchema, T as CUSTOM_EXPERT_SLUG, h as readLocalizedExpertPrompt, j as resolvePersonaLocale, k as formatHost, m as readExpertPrompt, t as AGENCY_PERSONA_SERVICE, w as AGENCY_LIBRARY_SERVICE } from "./src-CGY5G93z.js";
import { z } from "zod";
...
const personaLocaleSchema = z.enum([
	"follow",
	"zh",
	"en"
]);
...
let AgencyAgentsRemote = (() => {
	...
	let _getPersonaLocale_decorators;
	let _setPersonaLocale_decorators;
	return class AgencyAgentsRemote extends _classSuper {
		static {
			...
			_getPersonaLocale_decorators = [Remote("getPersonaLocale")];
			_setPersonaLocale_decorators = [Remote("setPersonaLocale")];
			...
			__esDecorate(this, null, _getPersonaLocale_decorators, {
				kind: "method",
				name: "getPersonaLocale",
				static: false,
				private: false,
				access: {
					has: (obj) => "getPersonaLocale" in obj,
					get: (obj) => obj.getPersonaLocale
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
			__esDecorate(this, null, _setPersonaLocale_decorators, {
				kind: "method",
				name: "setPersonaLocale",
				static: false,
				private: false,
				access: {
					has: (obj) => "setPersonaLocale" in obj,
					get: (obj) => obj.setPersonaLocale
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
		...
		async getPrompt(slug, division) {
			const value = this.ctx.settings.get(AGENCY_SETTINGS_NAMESPACE);
		...
		/** 更新人设语言设置；过期修订号拒绝写入。 */
		async setPersonaLocale(personaLocale, expectedRevision) {
